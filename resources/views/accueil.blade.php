...
<body class="antialiased bg-gray-100">
    <div class="flex relative" x-data="{ navOpen: localStorage.getItem('menuOpen') === 'true' }">
        <!-- NAV -->
                    ...
                    <div class="py-4 text-gray-400 space-y-1">
                        ...
                        <div class="block" x-data="{open: localStorage.getItem('dropdownOpen') === 'true' }">
                            ...
                            <div x-show="open" class="text-sm border-l-2 border-gray-800 mx-6 my-2.5 px-2.5 flex flex-col gap-y-1">
                                <a href="{{ route('classe.index') }}" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded">
                                    Classe
                                </a>
                                <a href="{{ route('enseignant.index') }}" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded">
                                    Enseignant
                                </a>
                                <a href="{{ route('matiere.index') }}" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded">
                                    Matière
                                </a>
                                <a href="{{ route('eleve.index') }}" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded">
                                    Elève
                                </a>
                                <a href="{{ route('examen.index') }}" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded">
                                    Examen
                                </a>
                                <a href="{{ route('admin.afficher-note-admin') }}" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded">
                                    Notes
                                </a>
                                <hr>
                                <a href="{{ route('user.index') }}" class="block py-2 px-4 hover:bg-gray-800 hover:text-white rounded">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        @auth
                            ...
                            @else
                                ...
                                @endphp
                                <img src="https://ui-avatars.com/api/?name={{ urlencode($initials) }}&size=128&background=ff4433&color=fff" class="w-7 h-7 rounded-full" alt="">
                            @endif
                        @endauth

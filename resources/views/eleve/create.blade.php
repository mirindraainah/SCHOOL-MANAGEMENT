...
<div class="mb-5 flex flex-col md:flex-row justify-between items-center md:items-start">
    <div class="flex items-center">
        <h2 class="text-3xl font-extrabold text-gray-200 mt-2 md:mt-0 ml-2 transform hover:scale-105 transition-transform duration-300 ease-in-out">Ajouter un Élève</h2>
    </div>
...
<div class="bg-white shadow-md rounded-lg p-6">
    <form action="{{ route('eleve.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        @csrf

        <div class="col-span-1">
            <div class="mb-4">
                <label for="Matricule" class="block text-sm font-medium text-gray-700">Matricule</label>
                <input type="text" name="Matricule" placeholder="Matricule de l'élève" class="mt-1 p-2 border rounded-md w-full">
            </div>

            <div class="mb-4">
                <label for="NomEleve" class="block text-sm font-medium text-gray-700">Nom de l'Élève</label>
                <input type="text" name="NomEleve" placeholder="Nom de l'élève" required class="mt-1 p-2 border rounded-md w-full">
            </div>

            <div class="mb-4">
                <label for="PrenomEleve" class="block text-sm font-medium text-gray-700">Prénom de l'Élève</label>
                <input type="text" name="PrenomEleve" placeholder="Prénom de l'élève" required class="mt-1 p-2 border rounded-md w-full">
            </div>

            <div class="mb-4">
                <label for="DateNaissance" class="block text-sm font-medium text-gray-700">Date de Naissance</label>
                <input type="date" name="DateNaissance" placeholder="Date de Naissance" required class="mt-1 p-2 border rounded-md w-full">
            </div>
        </div>
        ...
        <div class="col-span-1">
            <div class="mb-4">
                ...
                <div class="flex items-center mt-2">
                    <input class="form-check-input" type="radio" name="Sexe" id="sexe_m" value="M" required checked>
                    <label class="ml-2 text-sm text-gray-600" for="sexe_m">Masculin</label>
                    <input class="form-check-input ml-4" type="radio" name="Sexe" id="sexe_f" value="F" required>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="AdresseEleve" placeholder="Adresse de l'élève" required class="mt-1 p-2 border rounded-md w-full">
            </div>
            ...
            <div class="mb-4">
                <label for="image" class="block text-sm font-medium text-gray-700">Image de l'Élève</label>
                <div class="flex items-center mt-2">
